...
namespace SICER.CONFIG.USERMODEL
{
    ...
    public class SAPTableEntity
    {
        ...
        public SAPbobsCOM.BoUTBTableType TableType { get; set; } = BoUTBTableType.bott_NoObject;
    ...
    public class SAPFieldEntity
    {
        ...
        public SAPbobsCOM.BoFieldTypes FieldType { get; set; } = BoFieldTypes.db_Alpha;
    ...
    public class SAPUDOEntity
    {
        ...
        public SAPbobsCOM.BoYesNoEnum ManageSeries { get; set; } = BoYesNoEnum.tNO;
