...
namespace SAPADDON.HELPER
{
    ...
    {
        public static Form CreateForm(SAPbobsCOM.Company company, SAPbouiCOM.Application application, string stringXml, string formName, string formId)
        {
